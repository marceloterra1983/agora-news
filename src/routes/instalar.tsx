...
const LINKS = {
  ...
  chromePlay: "https://play.google.com/store/apps/details?id=com.android.chrome",
} as const;
    ...
    <AppChrome category="ai">
      <main className="mx-auto max-w-3xl px-4 py-6 pb-24 sm:px-6 max-sm:max-w-none">
        ...
        <section className="mt-8 rounded-md border border-line bg-card p-5">
          ...
          <h2 className="mt-2 font-display text-2xl tracking-tight">Se o botão não aparecer</h2>
          ...
          <div className="mt-5 flex items-center gap-1.5">
            <IconLink href={LINKS.chromeInstall} target="_blank" rel="noreferrer" label="Guia oficial do Chrome">
              <Chrome className="size-4" />
            </IconLink>
            <IconLink href={LINKS.chromePlay} target="_blank" rel="noreferrer" label="Chrome na Play Store">
        ...
        <section className="mt-6 rounded-md border border-line bg-card p-5">
          <p className="text-xs font-semibold uppercase tracking-widest text-mark">iPhone</p>

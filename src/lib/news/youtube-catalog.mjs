...
export const YOUTUBE_SEED = [
  ...
  // Brasil — política, jornais, ciência e cultura (ranqueados pelo histórico)
  {
  ...
  }, // watch=13
  {
    ...
    blurb: "Commodities, safras, grãos e o dia a dia do campo brasileiro.",
  ...
  {
    channelId: "UCFKKzThiteu1WkrJIlVQEWg",
    url: "https://www.youtube.com/feeds/videos.xml?channel_id=UCFKKzThiteu1WkrJIlVQEWg",
    title: "Cláudio Dantas",
    section: "brasil",
    group: "br-analise",
    account: "y_b5267066c2db",
    blurb: "Bastidores e análise política do noticiário brasileiro.",
    avatar: "https://yt3.googleusercontent.com/3iobva7pGltgp8MmD5bEcXaxo6GnAzOHhhRiwMdu1Gn53YXx7e-oZ_v2UZeFuRvyk9IvPivDWQ=s176-c-k-c0x00ffffff-no-rj",
  },
  {
    ...
    blurb: "Astronomia, exploração espacial e divulgação científica em português.",
  ...
  },
  {
    ...
    blurb: "Física, cosmologia e o diálogo entre ciência e cultura.",
  ...
  {
    channelId: "UC9djCiv4e85Kd8G--GWlcoQ",
    url: "https://www.youtube.com/feeds/videos.xml?channel_id=UC9djCiv4e85Kd8G--GWlcoQ",
    title: "Ciência Sem Fim",
    section: "podcasts",
    group: "especialistas",
    account: "y_21584dcb9a94",
    blurb: "Podcast científico com Sérgio Sacani e convidados.",
    avatar: "https://yt3.googleusercontent.com/dJrn-Sg0uswxlTdNFcph4NG-aw2chcPpS4kVao1kQKsXRtysMn0T62Nz1WrBmDh630N2tSPtpys=s176-c-k-c0x00ffffff-no-rj",
  },
  {
    ...
    blurb: "Entrevistas longas da TV Cultura com convidados da atualidade.",
  ...
  {
    channelId: "UC7f35v8GI1O_f6x2PfeOutQ",
    url: "https://www.youtube.com/feeds/videos.xml?channel_id=UC7f35v8GI1O_f6x2PfeOutQ",
    title: "CNN Brasil Money",
    section: "mercados",
    group: "macro",
    account: "y_a5b72b10096f",
    blurb: "Cobertura macro, economia e o dia a dia dos mercados.",
    avatar: "https://yt3.googleusercontent.com/mT6geLZL8TdD6Uc0M_oXqaMa3I9kF111db29amueqDOkMDb_fYj57drzOoPI-NDPXl6gmyDWols=s176-c-k-c0x00ffffff-no-rj",
  },
  {
    channelId: "UCM3vJxmuJJkk1r0yzFI9eZg",
    url: "https://www.youtube.com/feeds/videos.xml?channel_id=UCM3vJxmuJJkk1r0yzFI9eZg",
    title: "Investidor Sardinha",
    section: "mercados",
    group: "financas",
    account: "y_7033996eb56d",
    blurb: "Finanças pessoais, trading e educação financeira com Raul Sena.",
    avatar: "https://yt3.googleusercontent.com/q6bgR6BvYXgq3u9GF_MP_YrVW4myeX_ETDwgM68vUA4XkahJUCoxnFy-MnELZPd5n875FDi5Fw=s176-c-k-c0x00ffffff-no-rj",
  },
];
...
export function youtubeGroupFor(section) {
  ...
  if (section === "podcasts") return "entrevistas";
  if (section === "mercados") return "macro";
  return "labs";
}

...
[data-chrome=compact] .pill{display:inline-flex;height:48px;align-items:center;border-radius:999px;background:#161411;color:#f2eee4;padding:0 16px;font-size:17px;font-weight:600}
html.dark [data-chrome=compact] .pill{background:#f0e9e0;color:#12100e}
[data-theme-toggle]{display:inline-flex;height:48px;align-items:center;gap:6px;border-radius:999px;border:1px solid #d5cfbf;background:#faf7f0;color:#161411;padding:0 12px;font-size:17px;font-weight:600;flex-shrink:0}
...
[data-chrome=tabs] a{display:flex;min-width:56px;min-height:56px;flex-direction:column;align-items:center;justify-content:center;font-size:12px;gap:2px}
a[data-cta=open-x]{display:grid;place-items:center;width:48px;height:48px;padding:0;border-radius:999px;border:1px solid #d5cfbf;background:transparent;color:#161411}

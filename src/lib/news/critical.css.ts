...
[data-section-switch]{display:inline-flex;height:44px;align-items:center;border-radius:999px;background:#e8e2d6;padding:2px;flex-shrink:0}
html.dark [data-section-switch]{background:#1a1714}
html.dark [data-chrome=compact] .pill{background:#f0e9e0;color:#12100e}
[data-theme-switch]{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:2px;border-radius:999px;background:#e8e2d6;padding:2px}
html.dark [data-theme-switch]{background:#1a1714}

...
[data-chrome=compact] .pill{display:inline-flex;height:44px;align-items:center;border-radius:999px;background:#161411;color:#f2eee4;padding:0 14px;font-size:15px;font-weight:600}
html.dark [data-chrome=compact] .pill{background:#f0e9e0;color:#12100e}
[data-theme-toggle]{display:inline-flex;height:44px;align-items:center;gap:6px;border-radius:999px;border:1px solid #d5cfbf;background:#faf7f0;color:#161411;padding:0 12px;font-size:15px;font-weight:600;flex-shrink:0}
...
[data-chrome=tabs] a{display:flex;min-width:48px;min-height:48px;flex-direction:column;align-items:center;justify-content:center;font-size:12px;gap:2px}

...
export function originsInHandles(handles: Iterable<string>): Array<"x" | "rss" | "youtube">;
...
export function storyIsYouTube(story: { id?: string; source?: string } | null | undefined): boolean;
export function filterStoriesByOrigin<T extends { id?: string; source?: string }>(
  stories: T[],
  opts?: { showX?: boolean; showRss?: boolean; showYouTube?: boolean },
): T[];
